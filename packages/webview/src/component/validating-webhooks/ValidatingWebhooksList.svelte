...
const columns = [statusColumn, nameColumn, webhooksColumn, failurePolicyColumn, ageColumn];

const row = new TableRow<ValidatingWebhookUI>({});
</script>
...
<KubernetesObjectsList
  ...
  {#snippet emptySnippet()}
    <KubernetesEmptyScreen icon={icon['ValidatingWebhookConfiguration']} resources={['validatingwebhookconfigurations']} />
  {/snippet}
</KubernetesObjectsList>
