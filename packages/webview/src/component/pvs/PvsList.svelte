...
const columns = [statusColumn, nameColumn, storageClassColumn, capacityColumn, claimColumn, pvStatusColumn, accessModesColumn, reclaimPolicyColumn, ageColumn];

const row = new TableRow<PvUI>({});
</script>
