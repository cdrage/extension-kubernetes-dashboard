...
let descriptionColumn = new TableColumn<PriorityClassUI, string>('Description', {
...
const columns = [statusColumn, nameColumn, valueColumn, globalDefaultColumn, preemptionPolicyColumn, descriptionColumn, ageColumn];
